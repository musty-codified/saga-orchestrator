package com.mustycodified.musty_notification_service.models;

import com.fasterxml.jackson.databind.exc.UnrecognizedPropertyException;

import com.mustycodified.musty_notification_service.commonlib.exceptions.DataValidationException;
import com.mustycodified.musty_notification_service.commonlib.exceptions.SystemUnavailableException;
import com.mustycodified.musty_notification_service.commonlib.models.*;
...
import static com.mustycodified.musty_notification_service.commonlib.constants.ConstantsCommons.ORIGINAL_REQUEST;
import static com.mustycodified.musty_notification_service.commonlib.enums.ErrorCodesEnum.*;
...
public class ErrorHandlingProcessor implements Processor {
	...
	public void process(Exchange exchange) throws Exception {
		...
		} else if (exception instanceof ExchangeTimedOutException || exception instanceof SystemUnavailableException) {
			entry = new Item();
